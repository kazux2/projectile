      ...
      <div class="row">
        ...
        <div class="col-sm-8">
          <div class="row">
            ...
            <h1>
              <input v-if="isEditing" type="text" v-model="nicknameBufferComputed">
            </h1>
          </div>
          <div class="row">
          ...
          <div class="row">
            ...
            <b-button
              ...
              variant="info"
              v-if="isEditing"
              @click="updateUserProfile({image: selectedImageRaw, nickname:nicknameBuffer, summery: summeryBuffer}); isEditing = false"
            >Save</b-button>
          </div>
        </div>
      </div>
